...
- **用法：**
  ...
  设置对象的属性。如果对象是响应式的，确保创建后的属性也是响应式的，并且能够触发视图更新。这主要用于解决 Vue 无法检测属性添加的限制。

  <p class="tip">目标对象不能是一个 Vue 实例，或者 Vue 实例的根数据对象。</p>
...
- **用法：**
  ...
  删除对象的属性。如果对象是响应式的，确保删除能触发更新视图。这个方法主要用于解决 Vue 无法检测到属性删除的限制，但是你应该很少会用到此方法。
