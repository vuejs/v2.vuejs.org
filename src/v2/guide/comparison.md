...
- Il ne propose qu'un seul template qui présume que vous concevez une application web mono-page, là où Vue offre une large variété de templates pour différents objectifs et outils de build.
