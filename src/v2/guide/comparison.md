...
For a pure component, the render output is only dependent on itself states. For a non-pure component, the render output is dependent on itself states and parents' states.
