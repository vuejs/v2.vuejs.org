...
Recreating dynamic components is normally useful behavior, but in this case, those tab component instances would ideally be cached once they're created for the first time. To solve this problem, you can wrap the dynamic component with a `<keep-alive>` element:
