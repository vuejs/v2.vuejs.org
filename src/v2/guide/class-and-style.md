...
A common need for data binding is manipulating an element's class list and its inline styles. Since they are both attributes, you can use `v-bind` to handle them. All you need to calculate is a final string with your expressions.
