...
Unlike the other modifiers, which are exclusive to native DOM events, the `.once` modifier can also be used on [component events](components-custom-events.md). If you haven't read about components yet, don't worry about this for now.
