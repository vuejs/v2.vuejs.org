...
Vue 社区正在急速增长中，如果你正在阅读本文，这是你准备好加入 Vue 社区的大好机会。欢迎！
...
- [vuex](https://github.com/vuejs/vuex)：类 state 的状态管理架构
- [vue-router](https://github.com/vuejs/vue-router)：用于单页面应用程序的路由系统
