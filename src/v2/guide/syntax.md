...
<p class="tip">Template expressions are sandboxed and only have access to a <a href="https://github.com/vuejs/vue/blob/v2.6.10/src/core/instance/proxy.js#L9">whitelist of globals</a> such as `Math` and `Date`. You should not attempt to access user defined globals in template expressions.</p>
