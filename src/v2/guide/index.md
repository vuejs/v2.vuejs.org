...
This is a contrived example, but it's demonstrated how to separate an app into two smaller units, and the child is reasonably well-decoupled from the parent via the `props` interface. At this point, you can continue to improve the `<todo-item>` component with more complex template and logic without affecting the parent app.
