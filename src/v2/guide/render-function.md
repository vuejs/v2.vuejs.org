...
functional components are just functions, they're much cheaper to render. now they can show up in the [Vue devtools v5+](https://github.com/vuejs/vue-devtools) component tree, but the previous version won't.
