...
If you're upgrading an existing application or just want tips on replacing deprecated features, you're in the right place. However, this page will not provide a list of all the new features in Vue 2.0. That would make this page larger than the rest of the guide combined! Instead, it's recommended to just take a day to browse through the new guide.
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find all examples of this hook.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the deprecated argument order. Note that if you name your index arguments something unusual like <code>position</code> or <code>num</code>, the helper will not flag them.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the deprecated argument order. Note that if you name your key arguments something like <code>name</code> or <code>property</code>, the helper will not flag them.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of these deprecated variables. If you miss any, you should also see <strong>console errors</strong> such as: <code>Uncaught ReferenceError: $index is not defined</code></p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>track-by</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the <code>coerce</code> option.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the <code>twoWay</code> option.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the <code>.once</code> and <code>.sync</code> modifiers.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the <code>debounce</code> attribute.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the these deprecated param attributes.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of style bindings with `!important` in objects.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>v-el</code> and <code>v-ref</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the <code>v-else</code> with <code>v-show</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the <code>transition</code> attribute.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the <code>transition</code> attribute. During your update, you can transition (pun very much intended) to the new staggering strategy as well.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the the old <code>keyCode</code> configuration syntax.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>$dispatch</code> and <code>$broadcast</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of filters being used inside directives. If you miss any, you should also see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the old filter syntax. If you miss any, you should also see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the deprecated text filters. If you miss any, you should also see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find CSS selectors targeting named slots (e.g. <code>[slot="my-slot-name"]</code>).</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find <code>keep-alive</code> attributes.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find HTML interpolations.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find one-time bindings.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of the deprecated usage.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>.$set</code> on an array. If you miss any, you should see <strong>console errors</strong> from the missing method.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>.$remove</code> on an array. If you miss any, you should see <strong>console errors</strong> from the missing method.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>Vue.set</code> or <code>Vue.delete</code> on a Vue instance. If you miss any, they'll trigger <strong>console warnings</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of overwriting <code>vm.$data</code>. If you miss any, <strong>console warnings</strong> will be emitted.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$get</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$appendTo</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$before</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$after</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$remove</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$eval</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$interpolate</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>vm.$log</code>. If you miss any, you'll see <strong>console errors</strong>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>replace: false</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>Vue.config.debug</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>Vue.config.async</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>Vue.config.delimiters</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>Vue.config.unsafeDelimiters</code>. After this, the helper will also find instances of HTML interpolation so that you can replace them with `v-html`.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>Vue.elementDirective</code>.</p>
</div>
{% endraw %}
...
<div class="upgrade-path">
  <h4>Upgrade Path</h4>
  <p>Run the <strong>migration helper</strong> on your codebase to find examples of <code>Vue.partial</code>.</p>
</div>
{% endraw %}
