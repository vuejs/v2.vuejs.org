...
Se você estiver escrevendo mutias funções `render`, pode se tornar penoso escrever muitas linhas de código ao invés de tirar proveito de uma sintaxe de mark-up que pode ser mais simples e legível:
